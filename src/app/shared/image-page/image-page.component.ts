...
import { ImagePageContent } from "./image-content";

import { ImagePageContentService } from "./image-page-content.service";

import { StepsId } from "../../config/enums/steps-id.enum";

import { PagesNameEnum } from "../../config/enums/pages-name.enum";
...
export class ImagePageComponent implements OnInit {
	...
	ngOnInit(): void {
		this.route.paramMap.subscribe((params) => {
			...
			this.imagePageContent = this.imagePageContentService.getContent(
				this.id
			);
		});
	}
